...
func SetupRoutes(app *app.Application) *chi.Mux {
	...
	r.Group(func(r chi.Router) {
		...
		// Workout routes
		// r.Get("/notes/{id}", app.Middleware.RequireUser(app.WorkoutHandler.HandleGetWorkoutByID))
		r.Post("/notes", app.Middleware.RequireUser(app.NoteHandler.HandleCreateNote))
		// r.Patch("/notes/{id}", app.Middleware.RequireUser(app.WorkoutHandler.HandleUpdateWorkout))
		// r.Delete("/notes/{id}", app.Middleware.RequireUser(app.WorkoutHandler.HandleDeleteWorkout))
	})
