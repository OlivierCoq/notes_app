...
// Get slug from params and fetch notes for that user
...
export const GET: RequestHandler = async ({ params, cookies }) => {
    try {
        ...
        // Here you would typically call your getAllNotes function
        const response = await fetch(`${PUBLIC_API_URL}/user-notes/${id}`, {
            method: 'GET',
            headers: {
